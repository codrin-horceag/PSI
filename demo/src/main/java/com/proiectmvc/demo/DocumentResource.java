...
//import y.domain.Document;
//import y.repository.DocumentRepository;
//import y.web.rest.errors.BadRequestAlertException;
//
///**
// * REST controller for managing {@link y.domain.Document}.
// */
//@RestController
//@RequestMapping("/api")
//@Transactional
...
//                if (document.getDataEliberare() != null) {
//                    existingDocument.setDataEliberare(document.getDataEliberare());
//                }
//                if (document.getDataIntocmire() != null) {
//                    existingDocument.setDataIntocmire(document.getDataIntocmire());
//                }
//                if (document.getNrDocument() != null) {
//                    existingDocument.setNrDocument(document.getNrDocument());
//                }
//
